...
export function HeaderTwo({ currentLang, onLanguageChange }: HeaderProps) {
            ...
            <div className="container-base px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex-shrink-0">
                        <Link href="/test" className="font-work-sans font-bold text-xl text-foreground">
                            Mydiploma
                        </Link>
                    </div>
                    ...
                    <nav>
                        <ul className="hidden lg:flex items-center space-x-6 font-medium text-gray-600 dark:text-gray-300">
                            ...
                            <li>
                                <DropdownMenu>
                                    <DropdownMenuTrigger className="py-3.5 flex items-center gap-2 group border-b-[3px] rounded-[2px] border-transparent hover:text-blue-700 dark:hover:text-blue-400 hover:border-blue-700 dark:hover:border-blue-400 transition-all duration-150">
                                        {t.nav.directions}
                                        <div className="transition">
                                            <ChevronDown className="group-data-[state=open]:hidden" />
                                            <ChevronUp className="hidden group-data-[state=open]:block" />
                            ...
                            <li>
                                <Link href="/test" className="hover-link border-b-[3px] rounded-[2px] border-transparent hover:text-blue-900 dark:hover:text-blue-400 hover:border-blue-900 dark:hover:border-blue-400 transition-all duration-150 pb-4">
                                    {t.nav.blog}
                                </Link>
                            </li>
                            <li>
