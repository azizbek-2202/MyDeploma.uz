        ...
        <div>
            ...
            <div className="pt-10 pb-2.5 text-center bg-[#f8fbff]">
                <div className="container-base h-32">
                    <h2 className='text-5xl mb-4 font-semibold text-blue-900'>{t.about.main.title}
                    </h2>
            ...
            <div className="bg-white pt-20 px-40">
                <div className="container-base">
                    <h4 className='text-3xl mb-2 font-semibold text-blue-900'>{t.about.main.subTitle}</h4>
                    <div className="flex items-center my-8 text-lg bg-[#f8fbff] text-gray-500">
